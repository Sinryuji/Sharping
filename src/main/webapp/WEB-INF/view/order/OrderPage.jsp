...
<form name="orderForm" id="orderForm" action="payingCard" method="post">
<h1>OrderResult</h1>
...
<p>
<h3>결제정보</h3>
결제방법 선택 : <label><input type="radio" name="payingSelect" id="payBank">무통장 입금</label>&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="payingSelect" id="payCard">신용카드 결제</label><br>
<!--  카드 결제에 필요한 넘들 -->
