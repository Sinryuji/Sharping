...
<body>
	...
	<a href="<c:url value='/deliveryTracker'/>">
		<h1>DeliveryTracker</h1>
	</a>

	<form action="productList">
		<input type="text" name="keyword" placeholder="키워드를 입력하세요." /> <input
	...
	<c:if test="${empty authInfo}">
		...
		<p>
			...
			<a href="<c:url value='/regist'/>">[회원 가입]</a> <a
	...
	<c:if test="${!empty authInfo}">
		...
		<a href="<c:url value='/infoChange'/>">[회원정보 수정]</a>
		<br>
