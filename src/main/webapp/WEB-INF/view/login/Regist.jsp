...
<body>
	...
	<div class="reg">
		<div class="in">
			<input type="button" class="t" onclick="location.href='${pageContext.request.contextPath}/registMember'" value="구매자 회원가입">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button" class="t" onclick="location.href='${pageContext.request.contextPath}/registSeller'" value="판매자 회원가입">
		</div>
	</div>
</body>
</html>